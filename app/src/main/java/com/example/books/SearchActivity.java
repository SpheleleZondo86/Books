        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (title.isEmpty() && author.isEmpty() && publisher.isEmpty() && isbn.isEmpty()){
                    String message = getString(R.string.valid_search_message);
                    Toast.makeText(SearchActivity.this, message, Toast.LENGTH_SHORT).show();
                }else {
                    URL queryUrl = ApiUtil.buildUrl(title, author, publisher, isbn);
                    Context context = getApplicationContext();
                    int position = SharedPreferencesUtil.getPrefsInt(context, SharedPreferencesUtil.POSITION);
                    ...
                    SharedPreferencesUtil.setPrefString(context, key, value);
                    SharedPreferencesUtil.setPrefInt(context, SharedPreferencesUtil.POSITION, position);
